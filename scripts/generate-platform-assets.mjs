...
function buildClaudeHookScript() {
  return [
    ...
    "}",
    "",
    "if (/(^|[^a-z0-9-])(deep-research|stitch|design|web-ui-design|mobile-ui-design|frontend-design-system|skill-creator|api-design|database-design)([^a-z0-9-]|$)/i.test(normalized)) {",
    "  reminders.push(",
