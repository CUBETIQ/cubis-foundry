...
description: 'Callable Codex wrapper for @database-architect: Expert database architect for schema design, query optimization, migrations, and modern serverless databases. Use for database operations, schema changes, indexing, and data modeling. Triggers on database, sql, schema, migration, query, postgres, index, table.'
metadata:
...
# Agent Wrapper: @database-architect
...
- Source agent name: database-architect
- Source agent description: Expert database architect for schema design, query optimization, migrations, and modern serverless databases. Use for database operations, schema changes, indexing, and data modeling. Triggers on database, sql, schema, migration, query, postgres, index, table.
- Related skills from source agent: database-skills, database-design, database-optimizer
