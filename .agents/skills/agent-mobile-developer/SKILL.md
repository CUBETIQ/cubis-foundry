...
description: 'Callable Codex wrapper for @mobile-developer: Expert in React Native and Flutter mobile development. Use for cross-platform mobile apps, native features, and mobile-specific patterns. Triggers on mobile, react native, flutter, ios, android, app store, expo.'
metadata:
...
# Agent Wrapper: @mobile-developer
...
- Source agent name: mobile-developer
- Source agent description: Expert in React Native and Flutter mobile development. Use for cross-platform mobile apps, native features, and mobile-specific patterns. Triggers on mobile, react native, flutter, ios, android, app store, expo.
- Related skills from source agent: mobile-design, flutter-expert, flutter-test-master
