...
description: 'Callable Codex wrapper for @seo-specialist: SEO and GEO (Generative Engine Optimization) expert. Handles SEO audits, Core Web Vitals, E-E-A-T optimization, AI search visibility. Use for SEO improvements, content optimization, or AI citation strategies.'
metadata:
...
- Source agent name: seo-specialist
- Source agent description: SEO and GEO (Generative Engine Optimization) expert. Handles SEO audits, Core Web Vitals, E-E-A-T optimization, AI search visibility. Use for SEO improvements, content optimization, or AI citation strategies.
- Related skills from source agent: seo-fundamentals, geo-fundamentals, web-perf
