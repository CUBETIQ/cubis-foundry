---
name: agent-code-archaeologist
description: 'Callable Codex wrapper for @code-archaeologist: Expert in legacy code, refactoring, and understanding undocumented systems. Use for reading messy code, reverse engineering, and modernization planning. Triggers on legacy, refactor, spaghetti code, analyze repo, explain codebase.'
metadata:
  source: cubis-foundry
  wrapper: agent
  platform: codex
  agent-id: 'code-archaeologist'
---

# Agent Wrapper: @code-archaeologist
...
- Source agent name: code-archaeologist
- Source agent description: Expert in legacy code, refactoring, and understanding undocumented systems. Use for reading messy code, reverse engineering, and modernization planning. Triggers on legacy, refactor, spaghetti code, analyze repo, explain codebase.
- Related skills from source agent: spec-miner, legacy-modernizer, refactor
