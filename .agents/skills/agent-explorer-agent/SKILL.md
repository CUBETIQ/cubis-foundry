---
name: agent-explorer-agent
description: 'Callable Codex wrapper for @explorer-agent: Advanced codebase discovery, deep architectural analysis, and proactive research agent. The eyes and ears of the framework. Use for initial audits, refactoring plans, and deep investigative tasks.'
metadata:
  source: cubis-foundry
  wrapper: agent
  platform: codex
  agent-id: 'explorer-agent'
---

# Agent Wrapper: @explorer-agent
...
- Source agent name: explorer-agent
- Source agent description: Advanced codebase discovery, deep architectural analysis, and proactive research agent. The eyes and ears of the framework. Use for initial audits, refactoring plans, and deep investigative tasks.
- Related skills from source agent: spec-miner, architecture-designer
