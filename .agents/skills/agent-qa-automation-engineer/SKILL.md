---
name: agent-qa-automation-engineer
description: 'Callable Codex wrapper for @qa-automation-engineer: Specialist in test automation infrastructure and E2E testing. Focuses on Playwright, Cypress, CI pipelines, and breaking the system. Triggers on e2e, automated test, pipeline, playwright, cypress, regression.'
metadata:
  source: cubis-foundry
  wrapper: agent
  platform: codex
  agent-id: 'qa-automation-engineer'
---

# Agent Wrapper: @qa-automation-engineer
...
- Source agent name: qa-automation-engineer
- Source agent description: Specialist in test automation infrastructure and E2E testing. Focuses on Playwright, Cypress, CI pipelines, and breaking the system. Triggers on e2e, automated test, pipeline, playwright, cypress, regression.
- Related skills from source agent: playwright-expert, webapp-testing, test-master
