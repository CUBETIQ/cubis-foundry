...
description: 'Callable Codex wrapper for @project-planner: Smart project planning agent. Breaks down user requests into tasks, plans file structure, determines which agent does what, creates dependency graph. Use when starting new projects or planning major features.'
metadata:
  source: cubis-foundry
  wrapper: agent
  platform: codex
  agent-id: 'project-planner'
---

# Agent Wrapper: @project-planner
...
- Source agent name: project-planner
- Source agent description: Smart project planning agent. Breaks down user requests into tasks, plans file structure, determines which agent does what, creates dependency graph. Use when starting new projects or planning major features.
- Related skills from source agent: app-builder, plan-writing, architecture-designer
