...
**Related Skills:**
- **graphql-architect/steering/schema-design.md** - Type system patterns and schema structure
- **graphql-architect/steering/federation-guide.md** - Multi-service GraphQL architecture
