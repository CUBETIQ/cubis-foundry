---
name: vercel-cli-mcp
description: "Use Vercel CLI MCP capabilities for agent and tooling integration."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cli, mcp
  role: specialist
...
## Purpose
Use Vercel CLI MCP capabilities for agent and tooling integration.
