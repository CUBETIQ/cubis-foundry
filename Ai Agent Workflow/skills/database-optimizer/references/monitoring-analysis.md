...
### Profiling and Slow Query Capture
...
### MongoDB Alerts (Baseline Suggestions)

- **High query latency**: p95 query time above baseline
- **Collection scans**: rising docs examined vs returned
- **Connection spikes**: sudden increase in active connections
- **Replication lag**: secondary lag above baseline
- **Cache pressure**: high page faults or low cache hit ratio
- **Index usage**: frequently unused indexes or missing indexes
