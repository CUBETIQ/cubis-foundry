---
name: vercel-cli-core
description: "Use Vercel CLI core commands for deploy, inspect, logs, and diagnostics."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cli, core
  role: specialist
...
## Purpose
Use Vercel CLI core commands for deploy, inspect, logs, and diagnostics.
