---
name: vercel-log-drain-reference
description: "Implement log-drain schema handling and downstream pipeline mapping."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, log, drain, reference
  role: specialist
...
## Purpose
Implement log-drain schema handling and downstream pipeline mapping.
