...
description: "Set per-function runtime, duration, memory, and region configuration safely."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, function, config
  role: specialist
...
## Purpose
Set per-function runtime, duration, memory, and region configuration safely.
