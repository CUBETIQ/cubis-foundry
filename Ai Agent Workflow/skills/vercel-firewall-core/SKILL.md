---
name: vercel-firewall-core
description: "Operate Vercel Firewall controls and policy lifecycle management."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, security, firewall, core
  role: specialist
...
## Purpose
Operate Vercel Firewall controls and policy lifecycle management.
