---
name: vercel-functions-core
description: "Build and operate Vercel Functions with reliable request lifecycle handling."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, core
  role: specialist
...
## Purpose
Build and operate Vercel Functions with reliable request lifecycle handling.
