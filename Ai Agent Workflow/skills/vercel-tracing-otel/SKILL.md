---
name: vercel-tracing-otel
description: "Instrument and analyze traces with OpenTelemetry on Vercel."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, tracing, otel
  role: specialist
...
## Purpose
Instrument and analyze traces with OpenTelemetry on Vercel.
