---
name: vercel-environments
description: "Design and operate local, preview, production, and custom environment workflows."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, environments
  role: specialist
...
## Purpose
Design and operate local, preview, production, and custom environment workflows.
