---
name: vercel-cache-control-headers
description: "Apply Cache-Control and related headers for deterministic content freshness."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cache, control, headers
  role: specialist
...
## Purpose
Apply Cache-Control and related headers for deterministic content freshness.
