---
name: vercel-cdn-purging
description: "Run cache purge/invalidation workflows with low blast radius."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cache, cdn, purging
  role: specialist
...
## Purpose
Run cache purge/invalidation workflows with low blast radius.
