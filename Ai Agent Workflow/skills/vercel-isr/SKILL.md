---
name: vercel-isr
description: "Implement ISR and revalidation flows with safe fallback behavior."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cache, isr
  role: specialist
...
## Purpose
Implement ISR and revalidation flows with safe fallback behavior.
