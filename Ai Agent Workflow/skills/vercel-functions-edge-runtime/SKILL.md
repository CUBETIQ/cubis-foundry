---
name: vercel-functions-edge-runtime
description: "Build on Vercel Edge Runtime with compatibility and performance guardrails."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, edge, runtime
  role: specialist
...
## Purpose
Build on Vercel Edge Runtime with compatibility and performance guardrails.
