...
description: "Automate Vercel operations through REST APIs with robust error handling."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cli, rest, api
  role: specialist
...
## Purpose
Automate Vercel operations through REST APIs with robust error handling.
