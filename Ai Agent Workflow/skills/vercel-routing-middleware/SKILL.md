...
description: "Use Routing Middleware for pre-cache control, auth checks, and traffic shaping."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, routing, middleware
  role: specialist
...
## Purpose
Use Routing Middleware for pre-cache control, auth checks, and traffic shaping.
