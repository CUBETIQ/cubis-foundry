...
description: "Design cache behavior across Vercel Edge Network and origin workloads."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cache, cdn
  role: specialist
...
## Purpose
Design cache behavior across Vercel Edge Network and origin workloads.
