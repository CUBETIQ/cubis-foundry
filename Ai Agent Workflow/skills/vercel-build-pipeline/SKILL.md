...
description: "Operate build settings, build logs, and build-failure triage workflows."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, build, pipeline
  role: specialist
...
## Purpose
Operate build settings, build logs, and build-failure triage workflows.
