...
description: "Implement Python runtime patterns specific to Vercel Functions."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, python
  role: specialist
...
## Purpose
Implement Python runtime patterns specific to Vercel Functions.
