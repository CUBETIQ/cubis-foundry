---
name: vercel-deployment-promotion
description: "Promote deployments safely across environments with rollback-ready controls."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, promotion
  role: specialist
...
## Purpose
Promote deployments safely across environments with rollback-ready controls.
