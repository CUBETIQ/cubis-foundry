...
description: "Tune image optimization behavior, cache keys, and quality-cost tradeoffs."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cache, image, optimization
  role: specialist
...
## Purpose
Tune image optimization behavior, cache keys, and quality-cost tradeoffs.
