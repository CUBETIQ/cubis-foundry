---
name: vercel-log-trace-correlation
description: "Correlate logs and traces for precise root-cause isolation."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, log, trace, correlation
  role: specialist
...
## Purpose
Correlate logs and traces for precise root-cause isolation.
