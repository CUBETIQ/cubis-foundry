...
description: "Query and triage runtime logs for incident diagnosis and regression detection."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, runtime, logs
  role: specialist
...
## Purpose
Query and triage runtime logs for incident diagnosis and regression detection.
