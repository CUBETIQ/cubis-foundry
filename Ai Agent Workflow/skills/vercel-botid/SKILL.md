---
name: vercel-botid
description: "Implement BotID challenge behavior with minimal legitimate-user friction."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, security, botid
  role: specialist
...
## Purpose
Implement BotID challenge behavior with minimal legitimate-user friction.
