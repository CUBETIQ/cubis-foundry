...
description: "Implement Vercel microfrontend composition, routing, and release coordination."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, microfrontends
  role: specialist
...
## Purpose
Implement Vercel microfrontend composition, routing, and release coordination.
