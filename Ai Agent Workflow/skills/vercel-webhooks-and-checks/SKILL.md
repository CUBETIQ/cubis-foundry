---
name: vercel-webhooks-and-checks
description: "Design webhook and deployment check pipelines with idempotent handlers."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cli, webhooks, and, checks
  role: specialist
...
## Purpose
Design webhook and deployment check pipelines with idempotent handlers.
