...
description: "Apply runtime cache policies with freshness and correctness guarantees."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, runtime, cache
  role: specialist
...
## Purpose
Apply runtime cache policies with freshness and correctness guarantees.
