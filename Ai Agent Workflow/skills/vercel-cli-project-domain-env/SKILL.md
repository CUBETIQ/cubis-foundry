---
name: vercel-cli-project-domain-env
description: "Automate project, domain, and environment management via CLI."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, cli, project, domain, env
  role: specialist
...
## Purpose
Automate project, domain, and environment management via CLI.
