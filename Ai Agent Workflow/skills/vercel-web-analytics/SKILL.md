...
description: "Operate privacy-aware web analytics and KPI instrumentation."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, web, analytics
  role: specialist
...
## Purpose
Operate privacy-aware web analytics and KPI instrumentation.
