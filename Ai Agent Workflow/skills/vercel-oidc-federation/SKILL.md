---
name: vercel-oidc-federation
description: "Implement OIDC federation for short-lived cloud credentials on Vercel."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, security, oidc, federation
  role: specialist
...
## Purpose
Implement OIDC federation for short-lived cloud credentials on Vercel.
