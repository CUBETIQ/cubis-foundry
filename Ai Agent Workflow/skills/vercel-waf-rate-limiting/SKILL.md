---
name: vercel-waf-rate-limiting
description: "Apply rate-limiting strategy to protect expensive or sensitive endpoints."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, security, waf, rate, limiting
  role: specialist
...
## Purpose
Apply rate-limiting strategy to protect expensive or sensitive endpoints.
