---
name: vercel-functions-nodejs
description: "Implement Node.js runtime patterns specific to Vercel Functions."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, nodejs
  role: specialist
...
## Purpose
Implement Node.js runtime patterns specific to Vercel Functions.
