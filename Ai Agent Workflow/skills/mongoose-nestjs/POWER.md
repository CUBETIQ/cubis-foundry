...
| ------------------ | -------------------------------- | ---------------------------------------------- |
| Schema Design      | `references/schema-design.md`      | Creating schemas, indexes, virtuals, hooks     |
| Repository Pattern | `references/repository-pattern.md` | Base repository, custom queries, pagination    |
| Transactions       | `references/transactions.md`       | ACID operations, retry logic, session handling |
| Migrations         | `references/migrations.md`         | Schema versioning, data migrations             |
