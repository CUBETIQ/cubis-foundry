---
name: vercel-secure-compute
description: "Configure Secure Compute and private network access patterns."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, security, secure, compute
  role: specialist
...
## Purpose
Configure Secure Compute and private network access patterns.
