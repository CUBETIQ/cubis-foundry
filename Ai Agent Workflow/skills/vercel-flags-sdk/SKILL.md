...
description: "Implement Vercel Flags SDK in app code with deterministic evaluation."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, flags, sdk
  role: specialist
...
## Purpose
Implement Vercel Flags SDK in app code with deterministic evaluation.
