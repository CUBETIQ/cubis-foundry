---
name: vercel-alerts-monitoring
description: "Define alerts and monitoring thresholds tied to user-impact symptoms."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, alerts, monitoring
  role: specialist
...
## Purpose
Define alerts and monitoring thresholds tied to user-impact symptoms.
