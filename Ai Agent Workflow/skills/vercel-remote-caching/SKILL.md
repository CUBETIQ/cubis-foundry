---
name: vercel-remote-caching
description: "Operate Turborepo remote cache integration and cache-safety controls."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, remote, caching
  role: specialist
...
## Purpose
Operate Turborepo remote cache integration and cache-safety controls.
