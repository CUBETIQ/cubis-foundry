---
name: vercel-data-cache-nextjs
description: "Operate Next.js data cache strategy on Vercel for App Router workloads."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, data, cache, nextjs
  role: specialist
...
## Purpose
Operate Next.js data cache strategy on Vercel for App Router workloads.
