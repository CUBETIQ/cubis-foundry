---
name: vercel-multi-tenant
description: "Design multi-tenant Vercel architectures with domain and isolation controls."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, deployment, multi, tenant
  role: specialist
...
## Purpose
Design multi-tenant Vercel architectures with domain and isolation controls.
