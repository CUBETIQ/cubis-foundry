---
name: vercel-session-tracing
description: "Capture and inspect session traces to debug real user request paths."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, session, tracing
  role: specialist
...
## Purpose
Capture and inspect session traces to debug real user request paths.
