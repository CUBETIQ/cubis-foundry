---
name: vercel-observability-overview
description: "Build complete observability baselines across logs, traces, and analytics."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, observability, overview
  role: specialist
...
## Purpose
Build complete observability baselines across logs, traces, and analytics.
