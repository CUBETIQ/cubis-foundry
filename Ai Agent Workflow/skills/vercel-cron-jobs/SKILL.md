...
description: "Configure and verify scheduled cron jobs with idempotency and retry controls."
license: MIT
metadata:
  author: cubis-foundry
  version: "1.0.0"
  domain: vercel
  triggers: vercel, functions, cron, jobs
  role: specialist
...
## Purpose
Configure and verify scheduled cron jobs with idempotency and retry controls.
