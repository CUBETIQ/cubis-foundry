...
def load_agent(agents_dir: str, agent_name: str) -> Tuple[Optional[str], str, str]:
    """
...
def get_agents_dir(args_agents_dir: Optional[str], args_cwd: Optional[str]) -> str:
    """
...
def detect_caller_cli() -> Optional[str]:
    """
...
def resolve_cli(frontmatter_cli: Optional[str], default: str = "codex") -> str:
    """
