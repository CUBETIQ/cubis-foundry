...
model: inherit
skills: vercel-automation, vercel-project-configuration, vercel-functions-core, vercel-routing-middleware, vercel-cdn-cache, vercel-observability-overview, vercel-deployment-protection, vercel-domains, vercel-cli-core, vercel-ai-gateway-core, vercel-flags-platform, nextjs-developer, devops-engineer, monitoring-expert, secure-code-guardian, web-perf
---
# Vercel Expert
