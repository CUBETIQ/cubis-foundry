---
name: mcp-builder
description: "Use for greenfield end-to-end MCP server design: API research, workflow-centric tool selection, server architecture, and initial build planning."
