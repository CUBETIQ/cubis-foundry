---
name: postgres-pro
description: "Use for PostgreSQL-specific internals and operations: EXPLAIN ANALYZE, JSONB/index types, replication, extensions, VACUUM/autovacuum, and pg_stat monitoring."
license: MIT
metadata:
...
|-------|-----------|-----------|
| Performance | `steering/performance.md` | EXPLAIN ANALYZE, indexes, statistics, query tuning |
| JSONB | `steering/jsonb.md` | JSONB operators, indexing, GIN indexes, containment |
| Extensions | `steering/extensions.md` | PostGIS, pg_trgm, pgvector, uuid-ossp, pg_stat_statements |
| Replication | `steering/replication.md` | Streaming replication, logical replication, failover |
| Maintenance | `steering/maintenance.md` | VACUUM, ANALYZE, pg_stat views, monitoring, bloat |
