...
2. **Copy the template**:
   ```bash
   cp steering/_template.md steering/query-your-reference-name.md
   ```
...
See `steering/_template.md` for the complete template. Key elements:
...
See `steering/_contributing.md` for detailed guidelines. Key principles:
