---
name: sql-pro
description: "Use for database-agnostic SQL query design and optimization (CTEs, window functions, joins, execution plans) across multiple SQL dialects."
license: MIT
metadata:
...
|-------|-----------|-----------|
| Query Patterns | `steering/query-patterns.md` | JOINs, CTEs, subqueries, recursive queries |
| Window Functions | `steering/window-functions.md` | ROW_NUMBER, RANK, LAG/LEAD, analytics |
| Optimization | `steering/optimization.md` | EXPLAIN plans, indexes, statistics, tuning |
| Database Design | `steering/database-design.md` | Normalization, keys, constraints, schemas |
| Dialect Differences | `steering/dialect-differences.md` | PostgreSQL vs MySQL vs SQL Server specifics |
