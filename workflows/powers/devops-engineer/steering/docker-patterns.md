...
## Multi-stage Dockerfile (Bun - Recommended)
...
## Multi-stage Dockerfile (Node.js - Legacy)
...
## Docker Compose (Development with Bun)
...
services:
  app:
    ...
    ports:
      - "3000:3000"
    environment:
      - MONGO_URL=mongodb://mongo:27017/oneup
