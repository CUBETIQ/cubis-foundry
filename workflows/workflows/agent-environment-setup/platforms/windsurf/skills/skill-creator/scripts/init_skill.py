...
metadata:
  category: "[TODO: core-operating | languages | databases | frameworks-runtimes | workflow-specialists | vertical-composed]"
  layer: "[TODO: usually matches category]"
  canonical: true
  maturity: "incubating"
---
...
[TODO: Define the specialist posture and the artifact or task family this skill owns.]
...
- Keep the root structure aligned to `IDENTITY`, `BOUNDARIES`, and `SOP`.
