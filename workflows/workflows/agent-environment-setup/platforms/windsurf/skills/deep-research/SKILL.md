...
metadata:
  provenance:
    source: "community benchmark synthesis"
    snapshot: "Rebuilt for Foundry on 2026-03-09 using public deep-research style skill patterns and Foundry research workflow needs."
  category: "workflow-specialists"
  layer: "workflow-specialists"
  canonical: true
  maturity: "stable"
  tags: ["research", "web-search", "corroboration", "evidence", "synthesis", "planning"]
---
