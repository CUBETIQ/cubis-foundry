...
## Antigravity Stitch Implementation Handoff
...
- Keep the result repo-native on Antigravity: reuse local primitives and explain any intentional drift from the Stitch artifact.
