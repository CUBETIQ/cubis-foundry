...
## Antigravity Design Context Sync
...
- Derive the design system from repo truth first, then use Stitch artifacts only to fill missing visual context on Antigravity.
