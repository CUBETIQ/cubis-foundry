...
- Primary specialist: `.agent/agents/frontend-specialist` (for frontend code) or `.agent/agents/backend-specialist` (for backend code)
- Security review: `.agent/agents/security-auditor`
- Quality validation: `.agent/agents/validator`
