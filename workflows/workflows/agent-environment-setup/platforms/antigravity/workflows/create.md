...
- Backend implementation: `.agent/agents/backend-specialist`
- Frontend implementation: `.agent/agents/frontend-specialist`
- Mobile implementation: `.agent/agents/mobile-developer`
