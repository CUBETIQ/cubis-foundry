...
- Primary coordinator: `.agent/agents/ci-cd-pipeline`
- Release verification: `.agent/agents/test-engineer`, `.agent/agents/validator`
- Documentation: `.agent/agents/documentation-writer`
