...
triggers: ["component", "react", "next", "ui", "ux", "css", "tailwind", "responsive", "app router", "accessibility", "frontend review"]
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: react-expert, nextjs-developer, frontend-design, tailwind-patterns, design-system-builder, web-perf, frontend-code-review, typescript-pro, javascript-pro
---
