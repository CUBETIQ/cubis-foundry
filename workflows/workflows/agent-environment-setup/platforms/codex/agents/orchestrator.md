...
> **NEVER do implementation work yourself. EVERY piece of work MUST be delegated to a specialist posture.**
...
- **Context loss**: every delegation must include full context — posture do not remember previous interactions.
