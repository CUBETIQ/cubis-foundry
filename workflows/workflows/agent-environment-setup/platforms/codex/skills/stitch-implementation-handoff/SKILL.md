...
## Codex Stitch Implementation Handoff
...
- Keep the result repo-native on Codex: reuse local primitives and explain any intentional drift from the Stitch artifact.
