...
1. **Treat `docs/foundation/DESIGN.md` as canonical** — Every design-heavy task starts from the canonical design system document. Any Stitch-facing mirror is generated compatibility state only.
