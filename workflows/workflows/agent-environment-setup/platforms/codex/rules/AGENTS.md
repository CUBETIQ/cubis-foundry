...
Use this matrix to match incoming tasks to the correct skill and primary specialist posture. Load skills only after route resolution confirms the domain.
