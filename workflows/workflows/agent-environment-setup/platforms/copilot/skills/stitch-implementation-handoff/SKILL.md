...
## Copilot Stitch Implementation Handoff
...
- Keep the result repo-native on Copilot: reuse local primitives and explain any intentional drift from the Stitch artifact.
