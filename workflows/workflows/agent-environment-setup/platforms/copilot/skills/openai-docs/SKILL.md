...
metadata:
  provenance:
    ...
    snapshot: "Rebuilt for Foundry on 2026-03-09 using official OpenAI docs patterns and public agent-builder benchmarks."
  category: "workflow-specialists"
  layer: "workflow-specialists"
  canonical: true
  maturity: "stable"
  tags: ["openai", "docs", "api", "latest", "verification", "official-sources"]
---
# OpenAI Docs
