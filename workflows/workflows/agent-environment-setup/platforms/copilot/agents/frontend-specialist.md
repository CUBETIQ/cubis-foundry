...
## Skill routing
Prefer these skills when task intent matches: `react-expert`, `nextjs-developer`, `frontend-design`, `tailwind-patterns`, `design-system-builder`, `web-perf`, `frontend-code-review`, `react-best-practices`, `typescript-pro`, `javascript-pro`.
