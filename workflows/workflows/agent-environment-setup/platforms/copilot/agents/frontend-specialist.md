...
## Skill routing
Prefer these skills when task intent matches: `react-expert`, `nextjs-developer`, `frontend-design`, `tailwind-patterns`, `design-system-builder`, `web-perf`, `frontend-code-review`, `react-best-practices`, `i18n-localization`, `error-ux-observability`, `typescript-pro`, `javascript-pro`.
