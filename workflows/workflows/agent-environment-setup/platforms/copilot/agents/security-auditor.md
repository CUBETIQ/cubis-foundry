...
## Skill routing
Prefer these skills when task intent matches: `security-engineer`, `auth-architect`, `vulnerability-scanner`, `static-analysis`, `api-designer`, `graphql-architect`, `nodejs-best-practices`, `nestjs-expert`, `fastapi-expert`, `typescript-pro`, `javascript-pro`, `python-pro`, `golang-pro`, `rust-pro`.
