...
## Skill routing
Prefer these skills when task intent matches: `observability`, `docker-kubernetes`, `ci-cd-pipelines`, `debugging-strategies`, `python-pro`, `golang-pro`, `typescript-pro`.
