...
## Skill routing
Prefer these skills when task intent matches: `webapp-testing`, `playwright-e2e`, `testing-patterns`, `static-analysis`, `agentic-eval`, `debugging-strategies`, `typescript-pro`, `javascript-pro`, `python-pro`.
