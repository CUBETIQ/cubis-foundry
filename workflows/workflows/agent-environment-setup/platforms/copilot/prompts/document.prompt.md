...
Documentation workflow: explore the codebase, generate accurate documentation, and review it for quality.
...
Attached skills:
- Load these exact skill IDs first: `tech-doc`, `architecture-doc`, `deep-research`, `code-review`.
- Local skill file hints if installed: `.github/skills/tech-doc/SKILL.md`, `.github/skills/architecture-doc/SKILL.md`, `.github/skills/deep-research/SKILL.md`, `.github/skills/code-review/SKILL.md`.
