...
Test authoring and coverage improvement: explore the code, write comprehensive tests, and review test quality.
...
Attached skills:
- Load these exact skill IDs first: `unit-testing`, `integration-testing`, `deep-research`, `playwright-interactive`, `code-review`.
- Local skill file hints if installed: `.github/skills/unit-testing/SKILL.md`, `.github/skills/integration-testing/SKILL.md`, `.github/skills/deep-research/SKILL.md`, `.github/skills/playwright-interactive/SKILL.md`, `.github/skills/code-review/SKILL.md`.
