...
Attached skills:
- Load these exact skill IDs first: `web-testing`, `android-emulator-testing`, `ios-simulator-testing`.
- Local skill file hints if installed: `.github/skills/web-testing/SKILL.md`, `.github/skills/android-emulator-testing/SKILL.md`, `.github/skills/ios-simulator-testing/SKILL.md`.
