...
Resolve the design engine first, produce a high-signal screen brief, then optionally hand off to Stitch or implementation.
...
Attached skills:
- Load these exact skill IDs first: `frontend-design`, `frontend-design-core`, `frontend-design-style-selector`, `frontend-design-screen-brief`, `frontend-design-mobile-patterns`, `stitch-prompt-enhancement`, `stitch-design-system`, `stitch-design-orchestrator`, `frontend-design-implementation-handoff`, `stitch-implementation-handoff`.
- Local skill file hints if installed: `.github/skills/frontend-design/SKILL.md`, `.github/skills/frontend-design-core/SKILL.md`, `.github/skills/frontend-design-style-selector/SKILL.md`, `.github/skills/frontend-design-screen-brief/SKILL.md`, `.github/skills/frontend-design-mobile-patterns/SKILL.md`, `.github/skills/stitch-prompt-enhancement/SKILL.md`, `.github/skills/stitch-design-system/SKILL.md`, `.github/skills/stitch-design-orchestrator/SKILL.md`.
