...
Attached skills:
- Load these exact skill IDs first: `frontend-design`, `design`, `web-ui-design`, `mobile-ui-design`, `desktop-ui-design`, `design-system`.
- Local skill file hints if installed: `.github/skills/frontend-design/SKILL.md`, `.github/skills/design/SKILL.md`, `.github/skills/web-ui-design/SKILL.md`, `.github/skills/mobile-ui-design/SKILL.md`, `.github/skills/desktop-ui-design/SKILL.md`, `.github/skills/design-system/SKILL.md`.
