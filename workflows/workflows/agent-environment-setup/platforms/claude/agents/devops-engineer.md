...
model: inherit
skills: javascript-pro, typescript-pro, python-pro, golang-pro, nodejs-best-practices, debugging-strategies, webapp-testing, ci-cd-pipelines, docker-kubernetes, observability, git-workflow
---
