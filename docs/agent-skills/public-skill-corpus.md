...
- Repos reviewed: 19
- Repo classes: `public-implementation` (5), `awesome-list` (4), `aggregate-library` (3), `installer-registry` (3), `official` (2), `marketplace` (1), `open-standard` (1)
- Source groups: `community-library` (4), `curated-discovery` (4), `distribution-and-portability` (4), `coding-specialists` (2), `official-baseline` (2), `google-oriented` (1), `spec-and-portability` (1), `workflow-and-planning` (1)
- Strongest taxonomy signals: `automation` (16), `coding` (14), `product` (4), `registry` (4), `research` (4), `design` (3), `docs` (3), `analysis` (2), `authoring` (2), `gemini` (2)
...
| [heilcheng/awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills) | awesome-list | multi-agent | 0 | n/a | discovery, cross-platform-breadth, category-check |
| [mhattingpete/claude-skills-marketplace](https://github.com/mhattingpete/claude-skills-marketplace) | marketplace | claude | 0 | n/a | marketplace-signal, demand, discovery |
| [rknall/claude-skills](https://github.com/rknall/claude-skills) | public-implementation | claude | 0 | n/a | community-patterns, skill-structure |
| [aj-geddes/claude-code-bmad-skills](https://github.com/aj-geddes/claude-code-bmad-skills) | public-implementation | claude | 0 | n/a | workflow-shape, planning-patterns, agent-orchestration |
| [numman-ali/openskills](https://github.com/numman-ali/openskills) | aggregate-library | multi-agent | 0 | n/a | breadth, naming-patterns, missing-family-detection |
...
- Class: `open-standard`
- Signals: spec, registry, interoperability
- Notes: Useful for portable packaging assumptions and metadata shape, not for canonical wording.
...
- Class: `aggregate-library`
- Signals: coding, automation, docs, product, analysis
- Notes: Large local-first aggregate library that helps identify common skill names and overlap problems.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no
...
- Class: `public-implementation`
- Signals: coding, git, github, authoring, automation
- Notes: Smaller library with practical development-workflow skills and skill-authoring examples.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### vercel-labs/skills
- Class: `installer-registry`
- Signals: registry, install, coding, tooling
- Notes: Useful for install/sync assumptions and portable packaging expectations.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### skillmatic-ai/awesome-agent-skills
- Class: `awesome-list`
- Signals: coding, research, design, product, automation
- Notes: Another discovery-focused awesome list that helps validate whether candidate families recur across lists.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### heilcheng/awesome-agent-skills
- Class: `awesome-list`
- Signals: claude, codex, cline, gemini, automation
- Notes: Good cross-platform list for checking whether a skill family is ecosystem-wide rather than tool-local.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### mhattingpete/claude-skills-marketplace
- Class: `marketplace`
- Signals: marketplace, coding, automation, discovery
- Notes: Useful for understanding what skill families are marketed and surfaced to end users.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### rknall/claude-skills
- Class: `public-implementation`
- Signals: coding, automation, authoring
- Notes: Community package set that helps check how smaller authors structure reusable skills.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### aj-geddes/claude-code-bmad-skills
- Class: `public-implementation`
- Signals: planning, bmad, workflow, automation
- Notes: Structured workflow/planning library useful for orchestration, planning, and agent workflow skill design.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no

### numman-ali/openskills
- Class: `aggregate-library`
- Signals: coding, automation, docs, analysis, tooling
- Notes: Broad library useful for category spread and repeated naming patterns across public skill packs.
- README signals: skill.md=no, references=no, scripts=no, install=no, marketplace=no
