...
- **Enhancing an MCP integration?** The "Skills + MCP" section and Category 3 are for you. Both paths share the same technical requirements, but you choose what's relevant to your use case.
