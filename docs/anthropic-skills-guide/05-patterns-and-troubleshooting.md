...
- _Cause:_ File not named exactly `SKILL.md`
- _Solution:_ Rename to `SKILL.md` (case-sensitive). Verify with: `ls -la` should show `SKILL.md`

**Error: "Invalid frontmatter"**

- _Cause:_ YAML formatting issue
...
- _Cause:_ Name has spaces or capitals
