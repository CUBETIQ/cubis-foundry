...
22. **Use the canonical design routes for second-pass remediation** — When the task is diagnosis, design-state refresh, screen briefing, mobile adaptation, or implementation handoff, route through `design`, `design-audit`, `frontend-design-system`, `frontend-design-screen-brief`, `frontend-design-mobile-patterns`, and `frontend-design-implementation-handoff` instead of repeating bespoke design advice from scratch.
