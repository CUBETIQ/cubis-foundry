...
- Keep React component and hook unit tests in this skill and the owning TypeScript skill.
- Own React runtime-boundary checks here when they depend on rendering, client/server boundaries, Suspense behavior, or React-specific fixtures.
