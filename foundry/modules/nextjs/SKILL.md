...
- Keep Next.js route and component unit tests in this skill and the owning TypeScript skill.
- Own Next.js runtime-boundary checks here when they depend on routing, Server Components, middleware, API routes, caching, or app-router boundaries.
